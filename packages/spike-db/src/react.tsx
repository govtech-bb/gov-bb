...
export function useDocument(id: string | null): PageDocument | null | undefined {
...
export function useDocumentByUrl(
  url: string,
...
export function useRenderData(doc: PageDocument | null | undefined): RenderData {
  const keys = useMemo(() => {
    if (!doc) return []
