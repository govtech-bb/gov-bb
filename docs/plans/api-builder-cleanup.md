...
- **Frontend follow-up.** `apps/form_builder/` and `apps/forms/src/routes/admin/form-builder.tsx` still call these routes. Out of scope for this branch but needs a tracking issue so the UI doesn't ship broken 404s.
