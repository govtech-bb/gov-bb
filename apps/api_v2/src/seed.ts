/**
 * Loads the same seven pages, four collections and 163 pharmacy records the
 * browser spike seeds — imported from `@govtech-bb/spike-db`, not copied.
 *
 * Copying them would have been quicker and would have guaranteed drift: the
 * point of pointing both apps at this API is that they show the same estate,
 * and two seed corpora that are "the same" only by inspection will not stay
 * that way past the first edit to one of them.
 *
...
} from "@govtech-bb/spike-db/seed-data";
