...
// skips hidden fields, show-hide disclosure toggles, and content guidance
// blocks (UI affordances, not questions). `required` is the presence of a
// `required` rule. Escape-toggle
