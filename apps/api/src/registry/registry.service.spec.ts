...
describe("RegistryService", () => {
  ...
  describe("hydrateForm", () => {
    ...
    // Regression (catchmentRouting, #2152): the submission pipeline reads
    // `catchmentRouting` off the served contract to resolve the serving
    // polyclinic. When the api-side resolver was retired (#2024) that field had
    // to keep flowing through the consolidated shared hydrate — guard it here so
    // it can't be silently dropped again.
