// Minimal createServerFn shim for Vitest (CJS-compatible).
...
// Mirror runtime semantics: the .server impl wins once set; otherwise fall back
// to .client. Tests run in Node, so the .server branch is what we exercise.
