...
// protection plugin, which rejects any client-bundled module trying to
// import it. That keeps the `node:crypto` import below from leaking into
// the client bundle and crashing the route chunks (Vite stubs `node:crypto`
// in the browser, and any property access on the stub throws).
import {
  createCipheriv,
  createDecipheriv,
  randomBytes,
