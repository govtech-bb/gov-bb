 ...
 * `lib/content.ts` because it pulls in `gray-matter` (a Node/server dependency) — the
 * constants and validators in `lib/content` stay client-safe so the editor can import
