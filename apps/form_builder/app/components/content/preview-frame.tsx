...
export function StartPagePreviewFrame({
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100%" }}>
      ...
      />
      {!connected && !timedOut && (
        <div className="absolute inset-0 flex items-center justify-center bg-[color-mix(in_srgb,var(--ui-base)_92%,transparent)] p-6 text-center text-[14px] leading-[1.6] text-ui-subtle [&_code]:rounded-[3px] [&_code]:bg-ui-recessed [&_code]:px-1.25 [&_code]:py-px">
