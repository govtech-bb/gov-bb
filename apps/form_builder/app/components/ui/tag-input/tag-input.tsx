...
import { inputVariants, type InputVariant } from "../input/input";
...
export const TagInput = forwardRef<HTMLInputElement, TagInputProps>(
  (
    ...
    const chipClassName = cn(
      "flex w-fit max-w-full shrink-0 items-center gap-2.5 rounded-sm bg-ui-tint ring-1 ring-ui-hairline",
    ...
    const control = (
      ...
      >
        {values.map((item) => (
          <span key={item} className={cn(chipClassName, "text-ui-default")}>
