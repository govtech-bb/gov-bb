...
const SIDEBAR_EASING = "var(--ui-ease)";
const SIDEBAR_ANIMATION_DURATION_MS = 160;
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper relative isolate flex w-full [--sidebar-active-bg:var(--ui-tint)] [--sidebar-bg:var(--ui-base)]",
          !contained && !isMobile && "min-h-svh",
          "has-data-[variant=inset]:bg-ui-tint",
  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <aside
          ...
          className={cn(
            "relative flex h-full shrink-0 grow-0 flex-col overflow-hidden bg-(--sidebar-bg) text-ui-default",
            variant === "sidebar" &&
              (side === "left"
                ? "border-r border-ui-hairline"
                : "border-l border-ui-hairline"),
            variant === "floating" &&
              "m-2 rounded-lg border border-ui-hairline shadow-lg",
            className,
          )}
          {...props}
        >
      ...
      return (
        <>
          ...
          <div
            ...
            className={cn(
              contained
                ? "absolute inset-0 z-40 bg-ui-tint"
                : "fixed inset-0 z-40 bg-ui-tint",
          ...
          <nav
            ...
            className={cn(
              ...
              "bg-(--sidebar-bg) text-ui-default",
              // No border when full-screen — there is no adjacent content to divide.
              !fullScreenOnMobile && "border-r border-ui-hairline",
    ...
    return (
      <aside
        ...
        data-collapsible={collapsible}
        data-sidebar="sidebar"
        inert={collapsible === "offcanvas" && !contentExpanded}
        aria-hidden={collapsible === "offcanvas" && !contentExpanded}
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="header"
    className={cn(
      "flex h-[58px] shrink-0 items-center gap-1 border-b border-ui-hairline",
...
>(({ className, children, ...props }, ref) => {
  return (
    ...
    >
      ...
      >
        <ScrollAreaBase.Thumb className="flex-1 rounded-full bg-ui-hairline" />
      </ScrollAreaBase.Scrollbar>
    </ScrollAreaBase.Root>
  );
});
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="footer"
    className={cn(
      "flex h-12 shrink-0 items-center gap-4 overflow-hidden border-t border-ui-hairline whitespace-nowrap",
      ...
      "group-data-[state=collapsed]/sidebar:border-r group-data-[state=collapsed]/sidebar:border-ui-hairline",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "my-3 grid-rows-[0fr] border-b border-ui-hairline",
  ...
  >
    <div className="min-h-0 min-w-0">
      <div
        className={cn(
          "mt-4 mb-2 truncate px-3 text-sm font-medium text-ui-subtle",
...
const SidebarMenuButton = forwardRef<HTMLButtonElement, SidebarMenuButtonProps>(
  (
    ...
    const iconNode = (() => {
      ...
      const Comp = IconProp as React.ComponentType<{
        className?: string;
      }>;
      return (
        <Comp
        ...
        >
          {React.Children.map(children, (child) =>
            typeof child === "string" || typeof child === "number" ? (
              <AnimatedText active={active} className="truncate">
                {child}
              </AnimatedText>
            ) : (
              child
    ...
    const buttonClasses = cn(
      ...
      // Focus
      "focus:outline-none focus-visible:bg-(--sidebar-active-bg) focus-visible:text-ui-default",
      className,
    );
...
>(({ className, ...props }, ref) => (
  <span
    ...
    className={cn(
      "inline-flex shrink-0 items-center rounded-full border border-dashed border-ui-hairline",
      "px-1.5 py-0.5 text-[11px]/none font-medium text-ui-default select-none",
...
>(({ className, children, ...props }, ref) => (
  <ul
    ...
    {...props}
  >
    <div className="absolute inset-y-px left-[19px] z-10 w-px bg-ui-hairline" />
    {children}
  </ul>
));
...
>(({ className, active = false, href, target, children, ...props }, ref) => {
  ...
  const buttonClasses = cn(
    ...
    "before:absolute before:inset-x-0 before:-inset-y-px",
    "text-ui-default transition-[color] duration-150",
    !active && "hover:bg-(--sidebar-active-bg)",
    active && "bg-(--sidebar-active-bg)",
    "focus:outline-none focus-visible:bg-(--sidebar-active-bg) focus-visible:text-ui-default",
    className,
  ...
  if (href) {
    button = (
      <LinkComponent
        ...
        data-ui-component="Sidebar"
        data-ui-part="menu-sub-button-link"
      >
        {content}
      </LinkComponent>
    );
...
>(({ className, ...props }, ref) => (
  <div
    ...
    {...props}
  >
    <div className="border-b border-ui-hairline" />
  </div>
));
  ...
  return (
    ...
    >
      ...
      <path
        ...
        className={cn(
          "transition-transform duration-(--sidebar-animation-duration) ease-(--sidebar-easing)",
          expanded ? "translate-x-px" : "translate-x-[10.5px]",
        )}
      />
    </svg>
  );
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "text-ui-subtle hover:bg-(--sidebar-active-bg) hover:text-ui-default",
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-brand focus-visible:ring-inset",
        className,
      )}
      onClick={(e) => {
        onClick?.(e);
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:after:bg-ui-hairline focus-visible:after:bg-ui-hairline active:after:bg-ui-hairline",
        "focus:outline-none",
  ...
  (
    ...
    return (
      <SlidingViewActiveContext.Provider value={activeKey}>
        ...
        >
          <div
            className="ui-sidebar-slide flex min-h-0 w-full shrink-0 transition-transform duration-(--sidebar-animation-duration) ease-(--sidebar-easing) motion-reduce:transition-none"
            style={{
