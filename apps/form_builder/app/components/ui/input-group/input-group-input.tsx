  ...
  (props, ref) => {
    ...
    return (
      <InputExternal
        ref={ref}
        size={context?.size}
        disabled={context?.disabled || (props as InputProps).disabled}
