...
>(
  (
    ...
    const containerClassName = cn(
      ...
      // inputVariants provides base ring-ui-hairline; must come before state overrides
      inputVariants({ size, parentFocusIndicator: focusMode === "container" }),
      ...
      focusMode === "container"
        ? [
            "overflow-hidden",
            // Focus state must come AFTER inputVariants to override ring-ui-hairline
            "focus-within:ring-[1.5px] focus-within:ring-ui-focus/50",
          ]
      ...
      "has-[input[aria-invalid=true]]:ring-ui-danger",
    ...
    // Data attributes drive CSS selectors in the shared component stylesheet (focus outline)
          ...
          <InputGroupContext.Provider value={containerZoneContext}>
            <div
              ...
              className={cn(
                ...
                "focus-within:border-ui-focus/50",
