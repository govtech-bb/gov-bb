...
it("resets the description after a controlled close", async () => {
  ...
  const view = render(<PublishModal {...props} open />);
  const description = screen.getByRole("textbox", { name: /description/i });
  await user.type(description, "Unfinished note");
  ...
  view.rerender(<PublishModal {...props} open />);
  expect(
