...
import type { BodyEditorProfile } from "./types";
...
export function EditorToolbar({ profile }: { profile: BodyEditorProfile }) {
  ...
  return (
    <div
      className="relative flex min-w-0 flex-1 flex-wrap items-center gap-1 @max-[680px]:basis-full"
      role="toolbar"
    ...
    >
      ...
      />
      <span className="mx-0.75 h-4.5 w-px bg-ui-hairline" aria-hidden="true" />
      <ToolbarButton
        label="Undo"
