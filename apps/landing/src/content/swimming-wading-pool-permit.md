...
- get a paper application from the polyclinic and submit it to the polyclinic associated with the district where the pool is located. If you are unsure where to submit your paper application, you can call the Ministry of Health at [(246) 536-3800](tel:+12465363800)

## Before you start

You must apply for all amenities licences before this licence is granted, for example a restaurant, salon or spa licence.
...
Read the Health Services (Swimming Pools) Regulations, 1970 for the full legal requirements.
