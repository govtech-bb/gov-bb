...
shortDescription: Strategic management of the human resource function across the public service.
intro: >-
  Responsible for the strategic management of the human resource function across
  the Government of Barbados, including recruitment, selection, placement,
  promotion, discipline, retirement, and the training and development of public
  officers.
contact:
  - label: Email
    type: email
  ...
  - label: Email
    type: email
    value: HRPS@mps.gov.bb
  - label: Email
    type: email
    value: PRC@mps.gov.bb
  - label: Email
    type: email
    value: LD@mps.gov.bb
  - label: Telephone
  ...
  - label: Website
    type: website
    value: 'https://mps.gov.bb'
  - label: Address
    type: address
    value: >-
      E. Humphrey Walcott Building, Cnr. Collymore Rock and Culloden Road, St.
      Michael
onlineServices: []
...
<a data-start-link href="https://mps.gov.bb" target="_blank" rel="noopener noreferrer">Go to mps.gov.bb</a>

### Director of Human Resource Policy and Staffing
...
### Director of People Resourcing and Compliance
...
### Director, Learning and Development Directorate
