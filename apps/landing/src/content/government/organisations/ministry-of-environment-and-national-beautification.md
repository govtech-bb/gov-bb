...
shortDescription: 'Environmental protection, sustainable practices, and national aesthetics.'
intro: >-
  To protect the natural environment, promote sustainable practices, and enhance
  national aesthetics.
minister:
  name: 'The Hon. Santia J. O. Bradshaw, M.P.'
  role: >-
    Deputy Prime Minister, Minister of Environment, National Beautification and
    Fisheries, and Leader of Government Business in the House of Assembly
contact:
  - label: Email
    type: email
    value: ps.menb@barbados.gov.bb
  - label: Email
    type: email
...
> 3. Include stakeholder input into decision making."
...
For more on biodiversity and land resource management:

<a data-start-link href="https://biodiversity.gov.bb/" target="_blank" rel="noopener noreferrer">Go to biodiversity.gov.bb</a>
...
More on natural heritage:

<a data-start-link href="http://www.nhdbdos.com/" target="_blank" rel="noopener noreferrer">Go to nhdbdos.com</a>
...
More on solid waste programmes:

<a data-start-link href="https://solid.gov.bb/" target="_blank" rel="noopener noreferrer">Go to solid.gov.bb</a>
...
This is a national project which features a bulk waste collection exercise, community engagement sessions, de-bushing and beautifying of unsightly areas per parish and developing and maintaining behavioral change using the 4 planks Reduce, Reuse, Recycle and Recover thus embracing the Trees Save Lives maxim.

Clean and Green aims to improve the landscape of Barbados by removing unsightly garbage from areas where waste is accumulated and replacing with beautiful gardens.

| Channel   | Link                                                                                |
| --------- | ----------------------------------------------------------------------------------- |
| Facebook  | [facebook.com/officalcleanandgreen](https://www.facebook.com/officalcleanandgreen/) |
| Instagram | [@cleanandgreenbarbados](https://instagram.com/cleanandgreenbarbados)               |
| Twitter   | [@BarbadosGreen](http://twitter.com/BarbadosGreen)                                  |
...
More on the National Tree Planting project:

<a data-start-link href="http://www.weplantin.org/" target="_blank" rel="noopener noreferrer">Go to weplantin.org</a>
