...
keywords:
  ...
  - Diaspora
shortDescription: >-
  Manages consular functions including assistance for Barbadians abroad, visa
  agreements, government travel, and diaspora engagement.
intro: >-
  The Consular function has historically been linked to the development of
  international trade (commercial diplomacy), and to promoting the economic
  interests of nation states. The division handles assistance for Barbadians
  abroad, manages Honorary Consul recruitment, facilitates visa agreements,
  supports government travel, and coordinates deportation and extradition
  matters.
contact:
  - label: Website
    type: website
