...
- if you have more than one child at the same school, you only need to complete one form to claim on behalf of each child.
- if you have children at different schools, you will need to complete separate forms.

If the child is currently receiving support through the Primary School Textbook Grant, you are not eligible to claim the Primary School Textbook Grant as well.

## When to register

You can register at any time. If you register in June or July, the funds are more likely to be available before the new school year starts.
