-- Fix: replace components/relationship with components/name for text-based relationship fields
DELETE FROM form_definitions WHERE form_id = 'sell-goods-services-beach-park-test';
  ...
  '{
    ...
    "steps": [
      ...
      },
      {
        ...
        "elements": [
          {"ref": "components/generic/radio", "overrides": {"fieldId": "goods-or-services", "label": "Selling goods or services", "options": [{"label": "Goods", "value": "goods"}, {"label": "Services", "value": "services"}], "validations": {"required": {"value": true, "error": "Select an option"}}}}
        ]
      },
      {
        ...
        "elements": [
          {"ref": "components/generic/radio", "overrides": {"fieldId": "goods-origin", "label": "Where are the goods from?", "options": [{"label": "Local (Barbados)", "value": "barbados"}, {"label": "Imported", "value": "imported"}], "validations": {"required": {"value": true, "error": "Select an option"}}}},
      ...
      },
      {
        ...
        "elements": [
          ...
          {"ref": "components/name", "overrides": {"fieldId": "prof-ref-relationship", "label": "Relationship", "validations": {"required": {"value": true, "error": "Professional relationship is required"}}}},
      ...
      },
      {
        ...
        "elements": [
          ...
          {"ref": "components/name", "overrides": {"fieldId": "pers-ref-relationship", "label": "Relationship", "validations": {"required": {"value": true, "error": "Personal relationship is required"}}}},
      ...
      },
      {
        ...
        "elements": [
          ...
          {"ref": "components/name", "overrides": {"fieldId": "testimonial1-relationship", "label": "Relationship", "validations": {"required": {"value": true, "error": "Relationship is required"}}}},
      ...
      },
      {
        ...
        "elements": [
          ...
          {"ref": "components/name", "overrides": {"fieldId": "testimonial2-relationship", "label": "Relationship", "validations": {"required": {"value": true, "error": "Relationship is required"}}}},
